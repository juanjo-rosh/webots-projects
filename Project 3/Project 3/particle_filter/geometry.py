...
class SE2:
    ...
    def transform_point(self, point: Point) -> Point:
        ...
        new_x = self.T[0][0] * point.x + self.T[0][1] * point.y + self.T[0][2]
        new_y = self.T[1][0] * point.x + self.T[1][1] * point.y + self.T[1][2]
    ...
    def compose(self, other: 'SE2') -> 'SE2':
        ...
        new_x = self.T[0][0] * other.x + self.T[0][1] * other.y + self.T[0][2]
        new_y = self.T[1][0] * other.x + self.T[1][1] * other.y + self.T[1][2]
    ...
    def inverse(self) -> 'SE2':
        ...
        inverse_matrix = np.linalg.inv(self.T)
    
        new_x = inverse_matrix[0][2]
        new_y = inverse_matrix[1][2]
        new_h = math.atan2(inverse_matrix[1][0], inverse_matrix[0][0])
